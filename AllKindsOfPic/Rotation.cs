  ...
  public  class Rotation
    {
      ...
      public string RoteImg(int angle = 30)
        {
            var file = System.Web.HttpContext.Current.Server.MapPath("~/upload/redImg.png");
            ...
            var files = System.Web.HttpContext.Current.Server.MapPath("~/upload/combine/") + data + ".jpg";
            destImage.Save(files, ImageFormat.Jpeg);
            System.Drawing.Image myimg = destImage;
